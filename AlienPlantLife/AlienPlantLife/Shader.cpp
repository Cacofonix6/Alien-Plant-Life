...
Shader::Shader(const GLchar* _vertexPath, const GLchar* _fragmentPath, const char* _geometryPath)
{
...
{
	glUniform1i(glGetUniformLocation(ID, name.c_str()), (int)_value);
}
void Shader::setInt(const std::string &name, int _value) const 
{
	glUniform1i(glGetUniformLocation(ID, name.c_str()), _value);
}
void Shader::setFloat(const std::string &name, float _value) const 
{
	glUniform1f(glGetUniformLocation(ID, name.c_str()), _value);
}
